  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D]">
      ...
      <header className="sticky top-0 z-40 bg-[#1A1A1A] border-b border-[#2E2E2E] px-4 h-20 flex items-center gap-3">
        ...
        <h1 className="text-base font-bold text-[#F5F5F0]">Inventário</h1>
        ...
        <div className="flex gap-2 py-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full h-10 pl-9 pr-4 text-sm bg-[#1A1A1A] border border-[#2E2E2E] rounded-xl focus:outline-none focus:border-primary placeholder:text-[#9A9A9A]"
            />
            {search && (
              <button
                onClick={() => setSearch('')}
          ...
          <button
            ...
            className="h-10 w-10 flex-shrink-0 bg-[#1A1A1A] border border-[#2E2E2E] rounded-xl flex items-center justify-center text-[#C4C4C4] hover:bg-[#242424]"
          >
      ...
      <button
        ...
        className="fixed bottom-24 right-4 w-14 h-14 bg-primary text-[#141414] rounded-full shadow-lg flex items-center justify-center hover:bg-[#CFCFCF] active:scale-95 transition-transform z-30"
      >
        <Plus size={24} />
      </button>

      <Sheet open={filterOpen} onClose={() => setFilterOpen(false)} title="Filtros">
        <p className="text-sm text-[#9A9A9A]">Filtros adicionais em breve.</p>
      </Sheet>
    </div>
  )
}
