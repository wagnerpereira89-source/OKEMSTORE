  ...
  theme: {
    extend: {
      colors: {
        ...
        // ── Neutros do tema (vêm do config.js) ──
        canvas:    clientConfig.colors.canvas,
        surface:   clientConfig.colors.surface,
        elevated:  clientConfig.colors.elevated,
        line:      clientConfig.colors.line,
        ink:       clientConfig.colors.ink,
        muted:     clientConfig.colors.muted,
