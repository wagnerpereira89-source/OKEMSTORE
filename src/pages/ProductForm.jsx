...
export default function ProductForm() {
  ...
  const inputClass = 'w-full h-11 px-3 text-sm bg-[#1A1A1A] border border-[#2E2E2E] rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 placeholder:text-[#9A9A9A]'
  const priceInputClass = 'w-full h-11 pl-9 pr-3 text-sm bg-[#1A1A1A] border border-[#2E2E2E] rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 placeholder:text-[#9A9A9A]'
  const unitInputClass = 'w-full h-11 px-3 pr-10 text-sm bg-[#1A1A1A] border border-[#2E2E2E] rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 placeholder:text-[#9A9A9A]'
    ...
    <div className="min-h-screen bg-[#0D0D0D]">
      ...
      <div className="max-w-mobile mx-auto px-4 pb-32 space-y-4 py-4">
        ...
        <Card>
          ...
          {/* Propriedades */}
          <div className="mb-4">
            <p className="text-[18px] font-semibold text-[#F5F5F0] mb-3">Propriedades</p>
            <PropertySelector
          ...
          {form.attributes.length > 0 && (
            <div className="space-y-4 border-t border-[#2E2E2E] pt-4">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[12px] font-medium text-[#C4C4C4]">SKU (mesmo para todas as variações)</label>
                <input
              ...
              {/* Preços */}
              <p className="text-[15px] font-semibold text-[#F5F5F0]">Preços</p>
              ...
              {/* Estoque */}
              <p className="text-[15px] font-semibold text-[#F5F5F0]">Estoque</p>
              <div className="flex flex-col gap-1">
                <label className="text-[12px] font-medium text-[#C4C4C4]">Quantidade por variação</label>
              ...
              {/* Peso e dimensões */}
              <p className="text-[15px] font-semibold text-[#F5F5F0]">Peso e dimensões</p>
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
              ...
              <button
                ...
                className="w-full h-11 bg-primary text-[#141414] rounded-xl text-sm font-medium hover:bg-[#CFCFCF] active:scale-95 transition-transform"
              >
                Aplicar a todos
              </button>
              ...
              {generatedVariations.length > 0 && (
                <div className="space-y-2 pt-2">
                  <p className="text-[13px] font-medium text-[#C4C4C4]">Variações geradas</p>
        ...
        <Card>
          ...
          <p className="text-sm text-[#C4C4C4] mb-3">
            Adicione palavras-chave para ajudar seus clientes a encontrar este produto na loja.
          </p>
          <div className="flex flex-wrap gap-2 p-3 border border-[#2E2E2E] rounded-xl min-h-[44px]">
            {form.tags.map((tag) => (
              <span key={tag} className="inline-flex items-center gap-1 bg-[#242424] text-[#C4C4C4] text-sm px-2 py-0.5 rounded-full">
                {tag}
                <button type="button" onClick={() => setField('tags', form.tags.filter((t) => t !== tag))}
                  className="text-[#9A9A9A] hover:text-red-500 text-xs leading-none">×</button>
              </span>
            ))}
            <input
              value={tagInput}
      ...
      {/* Fixed save button */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-[#1A1A1A] border-t border-[#2E2E2E] max-w-mobile mx-auto">
      ...
      {uploading && (
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center">
          <div className="bg-[#1A1A1A] rounded-2xl p-6 flex flex-col items-center gap-3">
            <Loader2 size={32} className="animate-spin text-primary" />
            <p className="text-sm font-medium text-[#F5F5F0]">Enviando fotos...</p>
          </div>
        </div>
      )}
    </div>
