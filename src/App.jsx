...
function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#1A1A1A] border-t border-[#2E2E2E] max-w-mobile mx-auto">
      <div className="flex">
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex-1 flex flex-col items-center justify-center gap-1 h-16 transition-colors relative ${
                active ? 'text-primary' : 'text-[#9A9A9A]'
              }`}
            >
    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <div className="min-h-screen bg-[#0D0D0D]">
          <div className="max-w-mobile mx-auto min-h-screen bg-[#1A1A1A] shadow-sm">
            <Routes>
      ...
      <Toaster
        ...
        toastOptions={{
          ...
          success: { style: { background: config.colors.primary, color: '#141414' } },
